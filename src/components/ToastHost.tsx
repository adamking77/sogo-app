  ...
  return (
    <div className="pointer-events-none absolute inset-x-4 bottom-14 z-40 flex flex-col items-center gap-1.5">
      {toasts.map((toast) => (
        <div
          key={toast.id}
          className="sogo-pop sogo-surface-bg pointer-events-auto flex max-w-full items-center gap-2.5 rounded-full border border-cc-border py-1.5 pl-3.5 pr-1.5 text-xs shadow-xl"
        >
